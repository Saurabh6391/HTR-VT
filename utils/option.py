...
def get_args_parser():
    ...
    parser = argparse.ArgumentParser(
        description="Origami HTR Training",
        formatter_class=argparse.ArgumentDefaultsHelpFormatter
    )
    ...
    parser.add_argument("--train-bs", type=int, default=8)
    parser.add_argument("--val-bs", type=int, default=1)
    ...
    parser.add_argument("--cos-temp", type=int, default=8)

    parser.add_argument("--max-span-length", type=int, default=4)

    parser.add_argument("--spacing", type=int, default=0)

    parser.add_argument("--proj", type=float, default=8)
    ...
    parser.add_argument("--dpi-min-factor", type=float, default=0.5)
    parser.add_argument("--dpi-max-factor", type=float, default=1.5)

    parser.add_argument("--perspective-low", type=float, default=0.0)
    parser.add_argument("--perspective-high", type=float, default=0.4)

    parser.add_argument("--elastic-distortion-min-kernel-size",
                        type=int, default=3)

    parser.add_argument("--elastic-distortion-max-kernel-size",
                        type=int, default=3)

    parser.add_argument("--elastic-distortion-max-magnitude",
                        type=int, default=20)
    ...
    parser.add_argument("--elastic-distortion-min-sigma",
                        type=int, default=1)

    parser.add_argument("--elastic-distortion-max-sigma",
                        type=int, default=10)

    parser.add_argument("--dila-ero-max-kernel", type=int, default=3)

    parser.add_argument("--jitter-contrast", type=float, default=0.4)
    parser.add_argument("--jitter-brightness", type=float, default=0.4)
    parser.add_argument("--jitter-saturation", type=float, default=0.4)
    parser.add_argument("--jitter-hue", type=float, default=0.2)

    parser.add_argument("--dila-ero-iter", type=int, default=1)

    parser.add_argument("--blur-min-kernel", type=int, default=3)
    parser.add_argument("--blur-max-kernel", type=int, default=5)

    parser.add_argument("--blur-min-sigma", type=int, default=3)
    parser.add_argument("--blur-max-sigma", type=int, default=5)

    parser.add_argument("--zoom-min-h", type=float, default=0.8)
    parser.add_argument("--zoom-max-h", type=float, default=1)

    parser.add_argument("--zoom-min-w", type=float, default=0.99)
    parser.add_argument("--zoom-max-w", type=float, default=1)
    ...
    # --------------------------------------------------
    # Dataset paths (no subparser needed)
    # --------------------------------------------------

    parser.add_argument("--train-data-list",
                        default="./data/iam/train.ln")

    parser.add_argument("--val-data-list",
                        default="./data/iam/val.ln")

    parser.add_argument("--test-data-list",
                        default="./data/iam/test.ln")

    parser.add_argument("--data-path",
                        default="./data/iam/lines/")
